...
```
/docker-push-ecr . 654654554686.dkr.ecr.us-east-1.amazonaws.com/mlops-cloud-cost-anomaly/api:latest
```

```
/docker-push-ecr . 654654554686.dkr.ecr.us-east-1.amazonaws.com/mlops-cloud-cost-anomaly/api:v1.0.0
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Imagem 1: mlops-cloud-cost-anomaly/api:v1.0.0
  App:    .
...
- O projeto base fica em `/home/samuelsales/DevOps-projetos/mlops-cloud-cost-anomaly-platform/` — caminhos relativos sao resolvidos a partir dai
- O Dockerfile da API fica na raiz do projeto (a ser criado na Phase 4 — Docker)
